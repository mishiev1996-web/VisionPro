...
def normalize_team(fd_name: str) -> str:
    ...
    # Fuzzy fallback: try substring containment both ways
    for fd_key, real_name in NAME_MAP_RAW.items():
        if fd_key in n or n in fd_key:
            return real_name
    # Last resort: return original — db helper will try substring.
